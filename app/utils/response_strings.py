...
TEMPLATES: dict[str, dict[str, str]] = {
    ...
    "review_prompt": {
        "en": "We'd love your feedback! If you have a moment, you can leave a review here: {0}",
        "es": "¡Nos encantaría conocer tu opinión! Si tienes un momento, puedes dejar una reseña aquí: {0}",
        "hi": "हम आपकी प्रतिक्रिया सुनना चाहेंगे! यदि आपके पास समय हो, तो यहाँ समीक्षा छोड़ सकते हैं: {0}",
        "ur": "ہم آپ کی رائے سننا چاہیں گے! اگر آپ کے پاس وقت ہو تو یہاں ریویو چھوڑ سکتے ہیں: {0}",
        "pa": "ਅਸੀਂ ਤੁਹਾਡੀ ਰਾਏ ਸੁਣਨਾ ਚਾਹੁੰਦੇ ਹਾਂ! ਜੇਕਰ ਤੁਹਾਡੇ ਕੋਲ ਸਮਾਂ ਹੈ ਤਾਂ ਇੱਥੇ ਸਮੀਖਿਆ ਛੱਡ ਸਕਦੇ ਹੋ: {0}",
        "fr": "Nous serions ravis d'avoir votre avis ! Si vous avez un moment, vous pouvez laisser un commentaire ici : {0}",
        "de": "Wir freuen uns über Ihr Feedback! Wenn Sie einen Moment Zeit haben, können Sie hier eine Bewertung abgeben: {0}",
    },
    "otp_send_fail_email": {
    ...
    "otp_unavailable_skip_email": {
        "en": "We couldn't send a verification email right now (delivery issue on our side). We'll continue without email verification.",
        "es": "No pudimos enviar el correo de verificación ahora (problema de envío). Continuaremos sin verificación por correo.",
        "hi": "अभी सत्यापन ईमेल नहीं भेजा जा सका (तकनीकी समस्या)। हम बिना ईमेल सत्यापन के आगे बढ़ेंगे।",
        "ur": "ابھی تصدیقی ای میل نہیں بھیجی جا سکی (سسٹم کی طرف سے مسئلہ)۔ ہم ای میل تصدیق کے بغیر آگے بڑھیں گے۔",
        "pa": "ਹੁਣ ਤਸਦੀਕ ਈਮੇਲ ਨਹੀਂ ਭੇਜੀ ਜਾ ਸਕੀ (ਤਕਨੀਕੀ ਸਮੱਸਿਆ)। ਅਸੀਂ ਈਮੇਲ ਤਸਦੀਕ ਤੋਂ ਬਿਨਾਂ ਅੱਗੇ ਵਧਾਂਗੇ।",
        "fr": "Nous n'avons pas pu envoyer l'e-mail de vérification pour le moment (problème d'envoi). Nous continuons sans vérification par e-mail.",
        "de": "Wir konnten die Bestätigungs-E-Mail gerade nicht senden (Zustellproblem). Wir machen ohne E-Mail-Verifizierung weiter.",
    },
    "otp_unavailable_skip_phone": {
        "en": "We couldn't send a verification SMS right now (delivery issue on our side). We'll continue without SMS verification.",
        "es": "No pudimos enviar el SMS de verificación ahora (problema de envío). Continuaremos sin verificación por SMS.",
        "hi": "अभी सत्यापन एसएमएस नहीं भेजा जा सका (तकनीकी समस्या)। हम बिना एसएमएस सत्यापन के आगे बढ़ेंगे।",
        "ur": "ابھی تصدیقی ایس ایم ایس نہیں بھیجی جا سکی (سسٹم کی طرف سے مسئلہ)۔ ہم ایس ایم ایس تصدیق کے بغیر آگے بڑھیں گے۔",
        "pa": "ਹੁਣ ਤਸਦੀਕ ਐਸਐਮਐਸ ਨਹੀਂ ਭੇਜੀ ਜਾ ਸਕੀ (ਤਕਨੀਕੀ ਸਮੱਸਿਆ)। ਅਸੀਂ ਐਸਐਮਐਸ ਤਸਦੀਕ ਤੋਂ ਬਿਨਾਂ ਅੱਗੇ ਵਧਾਂਗੇ।",
        "fr": "Nous n'avons pas pu envoyer le SMS de vérification pour le moment (problème d'envoi). Nous continuons sans vérification par SMS.",
        "de": "Wir konnten die Bestätigungs-SMS gerade nicht senden (Zustellproblem). Wir machen ohne SMS-Verifizierung weiter.",
    },
    "otp_send_fail_phone": {
